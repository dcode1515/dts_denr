...
export default {
  ...
  methods: {
    ...
    //   } catch (error) {
    //     console.error("Error fetching released data:", error);
    //     this.$emit("show-notification", {
    //       message: "Failed to load released data.",
    //       type: "error",
    //     });
    //   } finally {
    //     this.loading = false;
...
<style scoped>
/* All styles from the previous tabs - same as ForReleaseTab styles */
/* Copy all styles from ForReleaseTab.vue's style section here */
/* Since all tabs share the same design, the styles are identical */
